...
def qpsk_awgn_generator(batch_size = 4500, EbN0s = [-10, -8]):
    data = {}
    ntaps = 45
    N_BITS = 1000000
    ...
    for EbN0 in EbN0s:
        ...
        amplitude = blocks.multiply_const_vcc((2, ))
        ...
        while sampler_indx + vec_length < len(raw_output_vector):
            ...
            data[("busy", EbN0)][0,:] = np.real(sampled_vector)
